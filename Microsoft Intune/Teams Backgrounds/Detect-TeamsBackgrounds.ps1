...
$MarkerFile = Join-Path $env:LOCALAPPDATA "Sonepar\TeamsBackgrounds\version.txt"
$ManifestFile = Join-Path $env:LOCALAPPDATA "Sonepar\TeamsBackgrounds\manifest.json"
...
try {
    ...
    $InstalledVersion = Get-Content -Path $MarkerFile -ErrorAction Stop
